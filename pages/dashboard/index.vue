      ...
      <div v-else class="lista">
        <div v-for="item in items" :key="item.id" class="card" @click="saveScroll">
          ...
          <div class="card-meta">
            ...
            <span v-if="esNueva(item.created_at)" class="chip-nueva">Nueva</span>
            ...
            <span v-if="item.created_at" class="meta-item meta-scrapeado">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
              Agregado {{ formatFechaRelativa(item.created_at) }}
            </span>
