  ...
  <div class="shell">
    ...
    <aside class="sidebar" :class="{ open: sidebarOpen }">
      ...
      <nav class="nav">
        ...
        <NuxtLink to="/dashboard/comparador" class="nav-item" active-class="active" @click="sidebarOpen = false">
        ...
        <template v-if="isAdmin">
          ...
          <template v-if="adminExpanded">
            ...
            <NuxtLink to="/dashboard/admin/blog" class="nav-item nav-sub" active-class="active" @click="sidebarOpen = false">
